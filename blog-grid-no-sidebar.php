...
<body class="blog grid-no-sidebar">
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="blog-grid-no-sidebar.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="blog-grid-no-sidebar.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="blog-grid-no-sidebar.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="blog-grid-no-sidebar.html#" class="custom-button purchase">Purchase</a>
    ...
    <div class="wrapper">
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active dropdown">
                                    <a href="blog-grid-no-sidebar.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i class="fa fa-angle-down"></i></a>
                                ...
                                <li class="dropdown">
                                    <a href="blog-grid-no-sidebar.html#" class="dropdown-toggle" data-toggle="dropdown">pages <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu">
			...
			<div class="row">
				<div class="content col-xs-12 col-md-12">
					...
					<article class="col-md-6">
						...
						<!-- Meta Starts -->
						<div class="meta">
							<span><i class="fa fa-user"></i> <a href="blog-grid-no-sidebar.html#">admin</a></span>
					...
					<nav class="col-xs-12 text-center" aria-label="Page navigation">
					  <ul class="pagination">
						<li>
						  <a href="blog-grid-no-sidebar.html#" aria-label="Previous">
							<span aria-hidden="true"><i class="fa fa-angle-double-left"></i></span>
						  </a>
						</li>
						<li><a href="blog-grid-no-sidebar.html#">1</a></li>
						<li class="active"><a href="blog-grid-no-sidebar.html#">2</a></li>
						<li><a href="blog-grid-no-sidebar.html#">3</a></li>
						<li><a href="blog-grid-no-sidebar.html#">4</a></li>
						<li>
						  <a href="blog-grid-no-sidebar.html#" aria-label="Next">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div class="social-footer">
                                <ul>
                                    <li><a href="blog-grid-no-sidebar.html#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="blog-grid-no-sidebar.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="blog-grid-no-sidebar.html#" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a href="blog-grid-no-sidebar.html#" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
        ...
        <!-- Footer Ends -->
		<!-- Back To Top Starts  -->
        <a href="blog-grid-no-sidebar.html#" id="back-to-top" class="back-to-top fa fa-arrow-up"></a>
		<!-- Back To Top Ends  -->
