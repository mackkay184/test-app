...
<body>
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="faq.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="faq.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="faq.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="faq.html#" class="custom-button purchase">Purchase</a>
    ...
    <div class="wrapper">
                    ...
                    <div class="site-nav-inner">
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="faq.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i class="fa fa-angle-down"></i></a>
                                ...
                                <li class="active dropdown">
                                    <a href="faq.html#" class="dropdown-toggle" data-toggle="dropdown">pages <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu">
            ...
            <div class="container">
                    ...
                    <div class="col-xs-12 col-md-8">
                        ...
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="faq.html#collapse1">
								what is bitcoin ?</a>
                                    </h4>
                                </div>
                                <!-- Panel Heading Ends -->
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#collapse2">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#collapse3">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#collapse4">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#collapse5">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#collapse6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#collapse7">
				...
				<div class="sidebar col-xs-12 col-md-4">
					...
					<div class="widget widget-tags">
						...
						<ul class="unstyled clearfix">
							<li><a href="faq.html#">currency</a></li>
							<li><a href="faq.html#">crypto</a></li>
							<li><a href="faq.html#">trading</a></li>
							<li><a href="faq.html#">wallet</a></li>
							<li><a href="faq.html#">mining</a></li>
							<li><a href="faq.html#">transaction</a></li>
							<li><a href="faq.html#">financial</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div class="social-footer">
                                <ul>
                                    <li><a href="faq.html#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="faq.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="faq.html#" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a href="faq.html#" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
        ...
        <!-- Footer Ends -->
        <!-- Back To Top Starts  -->
        <a href="faq.html#" id="back-to-top" class="back-to-top fa fa-arrow-up"></a>
        <!-- Back To Top Ends  -->
