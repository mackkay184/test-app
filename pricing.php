...
<body>
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="pricing.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="pricing.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="pricing.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="pricing.html#" class="custom-button purchase">Purchase</a>
    ...
    <div class="wrapper">
                    ...
                    <div class="site-nav-inner">
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <!-- <li class="dropdown"> -->
                                    <!-- <a href="pricing.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i class="fa fa-angle-down"></i></a> -->
                                ...
                                <!-- </li> -->
                                <!-- <li class="dropdown"> -->
                                    <!-- <a href="pricing.html#" class="dropdown-toggle" data-toggle="dropdown">pages <i class="fa fa-angle-down"></i></a> -->
                                    <!-- <ul class="dropdown-menu" role="menu"> -->
                                ...
                                <ul class="pricing-wrapper">
                                    ...
                                    <li>
                                        ...
                                        <footer class="pricing-footer">
                                            <a href="pricing.html#" class="btn btn-primary">ORDER NOW</a>
                                        </footer>
                                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div class="social-footer">
                                <ul>
                                    <li><a href="pricing.html#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="pricing.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="pricing.html#" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a href="pricing.html#" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
        ...
        <!-- Footer Ends -->
		<!-- Back To Top Starts  -->
        <a href="pricing.html#" id="back-to-top" class="back-to-top fa fa-arrow-up"></a>
		<!-- Back To Top Ends  -->
