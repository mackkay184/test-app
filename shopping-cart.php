...
<head>
    ...
    <meta charset="utf-8" />
    <title>Shopping Cart - Bayya Bitcoin Crypto Currency Template</title>
...
<body>
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="shopping-cart.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="shopping-cart.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="shopping-cart.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="shopping-cart.html#" class="custom-button purchase">Purchase</a>
    ...
    <div class="wrapper">
                    ...
                    <div class="site-nav-inner">
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="shopping-cart.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i class="fa fa-angle-down"></i></a>
                                ...
                                <li class="active dropdown">
                                    <a href="shopping-cart.html#" class="dropdown-toggle" data-toggle="dropdown">pages <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 table-responsive">
                        <table class="table order text-center">
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center"><a href="shopping-cart.html#" class="fa fa-trash icon-delete-product"></a></td>
					...
					<!-- Coupon Input Ends -->
					<!-- Update Cart Starts -->
                    <div class="col-xs-12 col-sm-5 text-center"><a href="shopping-cart.html#" class="btn btn-primary pull-right btn-update-cart">Update cart</a></div>
					<!-- Update Cart Ends -->
					<!-- Cart Totals Starts -->
                    <div class="col-xs-12 offset-5">
                        ...
                        <div><a href="shopping-checkout.html" class="btn btn-primary pull-right btn-proceed">Proceed to checkout</a></div>
                    </div>
					<!-- Cart Totals Ends -->
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div class="social-footer">
                                <ul>
                                    <li><a href="shopping-cart.html#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="shopping-cart.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="shopping-cart.html#" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a href="shopping-cart.html#" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
        ...
        <!-- Footer Ends -->
        <!-- Back To Top Starts  -->
        <a href="shopping-cart.html#" id="back-to-top" class="back-to-top fa fa-arrow-up"></a>
        <!-- Back To Top Ends  -->
