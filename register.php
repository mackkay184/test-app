					...
					<div>
						...
						<form action="registration.php" method="post">
							...
							<div class="form-group">
								<input class="form-control" name="firstname" id="firstname" placeholder="NAME" type="text" required>
							</div>
							<!-- Input Field Ends -->
							<!-- Input Field Starts -->
							<div class="form-group">
								<input class="form-control" name="middlename" id="middlename" placeholder="MIDDLE NAME" type="text" required>
							</div>

							<div class="form-group">
								<input class="form-control" name="lastname" id="lastname" placeholder="LAST NAME" type="lastName" required>
							</div>

							<div class="form-group">
								<input class="form-control" name="address" id="address" placeholder="ADDRESS" type="address" required>
							</div>
							...
							<div class="form-group">
								<input class="form-control" name="phone" id="phon" placeholder="PHONE" type="number" required>
							</div>
							<!-- Input Field Ends -->
							<!-- Input Field Starts -->
							<div class="form-group">
