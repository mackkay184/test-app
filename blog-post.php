...
<body class="blog">
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="blog-post.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="blog-post.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="blog-post.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="blog-post.html#" class="custom-button purchase">Purchase</a>
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active dropdown">
                                    <a href="blog-post.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i class="fa fa-angle-down"></i></a>
                                ...
                                <li class="dropdown">
                                    <a href="blog-post.html#" class="dropdown-toggle" data-toggle="dropdown">pages <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu">
					...
					<div class="container">
						...
						<div class="row text-center">
							<div class="col-xs-12">
								...
								<!-- Meta Starts -->
								<div class="meta">
									<span><i class="fa fa-user"></i> <a href="blog-post.html#">admin</a></span>
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. <br><br>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
								...
								<li>
									...
									<div class="comment">
										...
										<div class="comment-body">
											...
											<div>
												<a class="comment-reply" href="blog-post.html#">Reply</a>
											</div>	
										</div>
									</div>
									<!-- Comment Ends -->
				...
				<div class="sidebar col-xs-12 col-md-4">
					...
					<div class="widget">
						...
						<ul class="arrow nav nav-tabs second-font uppercase">
							<li><a href="blog-post.html#">Insurance</a></li>
							<li><a href="blog-post.html#">Announcement</a></li>
							<li><a href="blog-post.html#">Banking</a></li>
							<li><a href="blog-post.html#">Security</a></li>
							<li><a href="blog-post.html#">Regulation</a></li>
							<li><a href="blog-post.html#">Market Updates</a></li>
						</ul>
					</div>
					...
					<div class="widget">
						...
						<ul class="arrow nav nav-tabs second-font uppercase">
							<li><a href="blog-post.html#">January 2018</a></li>
							<li><a href="blog-post.html#">December 2017</a></li>
							<li><a href="blog-post.html#">November 2017</a></li>
							<li><a href="blog-post.html#">October 2017</a></li>
							<li><a href="blog-post.html#">September 2017</a></li>
						</ul>
					</div>
					...
					<div class="widget widget-tags">
						...
						<ul class="unstyled clearfix">
							<li><a href="blog-post.html#">currency</a></li>
							<li><a href="blog-post.html#">crypto</a></li>
							<li><a href="blog-post.html#">trading</a></li>
							<li><a href="blog-post.html#">wallet</a></li>
							<li><a href="blog-post.html#">mining</a></li>
							<li><a href="blog-post.html#">transaction</a></li>
							<li><a href="blog-post.html#">financial</a></li>
							<li><a href="blog-post.html#">security</a></li>
			            </ul>
					</div>
					<!-- Tags Widget Ends -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div class="social-footer">
                                <ul>
                                    <li><a href="blog-post.html#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="blog-post.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="blog-post.html#" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a href="blog-post.html#" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
        ...
        <!-- Footer Ends -->
		<!-- Back To Top Starts  -->
        <a href="blog-post.html#" id="back-to-top" class="back-to-top fa fa-arrow-up"></a>
		<!-- Back To Top Ends  -->
