...
<body class="auth-page">
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="login.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="login.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="login.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="login.html#" class="custom-button purchase">Purchase</a>
