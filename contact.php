...
<body>
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="contact.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="contact.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="contact.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="contact.html#" class="custom-button purchase">Purchase</a>
    ...
    <div class="wrapper">
                    ...
                    <div class="site-nav-inner">
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <!-- <li class="dropdown"> -->
                                    <!-- <a href="contact.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i class="fa fa-angle-down"></i></a> -->
                                ...
                                <!-- </li> -->
                                <!-- <li class="dropdown"> -->
                                    <!-- <a href="contact.html#" class="dropdown-toggle" data-toggle="dropdown">pages <i class="fa fa-angle-down"></i></a> -->
                                    <!-- <ul class="dropdown-menu" role="menu"> -->
                                ...
                                <div class="contact-info-box">
                                    ...
                                    <div class="contact-info-box-content">
                                        ...
                                        <div class="social-contact">
                                            <ul>
                                                <li class="facebook"><a href="contact.html#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                <li class="twitter"><a href="contact.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                                <li class="google-plus"><a href="contact.html#" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div class="social-footer">
                                <ul>
                                    ...
                                    <li><a href="contact.html#" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
        ...
        <!-- Footer Ends -->
        <!-- Back To Top Starts  -->
        <a href="contact.html#" id="back-to-top" class="back-to-top fa fa-arrow-up"></a>
        <!-- Back To Top Ends  -->
