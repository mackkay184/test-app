...
<body>
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a id="orange-css" href="services.html#" title="orange" class="color"><img src="images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="green-css" href="services.html#" title="green" class="color"><img src="images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
                </li>
                <li>
                    <a id="blue-css" href="services.html#" title="blue" class="color"><img src="images/styleswitcher/colors/blue.png" alt="" width="30" height="30" /></a>
                </li>
            </ul>
            ...
            <a href="services.html#" class="custom-button purchase">Purchase</a>
    ...
    <div class="wrapper">
                    ...
                    <div class="site-nav-inner">
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <!-- <li class="dropdown"> -->
                                    <!-- <a href="services.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i class="fa fa-angle-down"></i></a> -->
                                ...
                                <!-- </li> -->
                                <!-- <li class="dropdown"> -->
                                    <!-- <a href="services.html#" class="dropdown-toggle" data-toggle="dropdown">pages <i class="fa fa-angle-down"></i></a> -->
                                    <!-- <ul class="dropdown-menu" role="menu"> -->
        ...
        <section class="services">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>is the processing of transactions in the digital currency system, in which the records of current Bitcoin transactions, known as a blocks, are added to the record of past transactions</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6-offset-2 service-box">
						<div>
							<img id="strong-security" src="images/icons/orange/strong-security.png" alt="strong security"/>
							<div class="service-box-content">
								<h3>Bitcoin Transaction</h3>
								<p>is a transfer of value between Bitcoin wallets that gets included in the block chain. Bitcoin wallets keep a secret piece of data called a private key or seed, which is used to sign transactions,</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>is a digital marketplace where traders can buy and sell bitcoins using different fiat currencies or altcoins. A bitcoin currency exchange is an online platform that acts as an intermediary between buyers and sellers of the cryptocurrency. The currency ticker used for bitcoin is either BTC or XBT.</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p> It’s one of the biggest buzzwords in the financial technology industry right now, but also one of the least understood. With cryptocurrency back in the news again, now’s a better time than ever to delve into the weeds and learn more about how to invest</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div class="social-footer">
                                <ul>
                                    ...
                                    <li><a href="services.html#" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a href="services.html#" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
        ...
        <!-- Footer Ends -->
		<!-- Back To Top Starts  -->
        <a href="services.html#" id="back-to-top" class="back-to-top fa fa-arrow-up"></a>
		<!-- Back To Top Ends  -->
